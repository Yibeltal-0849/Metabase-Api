...
{
    public class GetprocPropertyRegistrationLoadAllVm2 : IMapFrom<PropertyRegistration2>
    {
        ...
        {
            profile.CreateMap<PropertyRegistration2, GetprocPropertyRegistrationLoadAllVm2>();
        }
    }
}
