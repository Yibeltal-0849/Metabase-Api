...
{
    public class GetprocContractQueryHandler : IRequestHandler<GetprocContractLoadByPrimaryKeyApplicationCode, GetprocContractLoadAllListVm>
    {
        ...
        public async Task<GetprocContractLoadAllListVm> Handle(GetprocContractLoadByPrimaryKeyApplicationCode request, CancellationToken cancellationToken)
        {
           
            IList<Contract> procContracts = await _procedureAdabter
               .Execute<Contract>("[dbo].[proc_ContractLoadByPrimaryKey_Application_Code]", request);
