...
namespace Application.dbo.Quiries.procaspnetUsers
{
    public class GetprocaspnetUsersLoadAllVm : IMapFrom<aspnetUsers>
    {
        ...
        {
            profile.CreateMap<aspnetUsers, GetprocaspnetUsersLoadAllVm>();
        }
    }
}
