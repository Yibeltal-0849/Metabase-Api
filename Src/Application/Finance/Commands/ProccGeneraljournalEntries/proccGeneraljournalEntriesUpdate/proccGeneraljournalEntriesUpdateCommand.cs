...
{ 
	...
	#region proc_c_General_journal_Entries Update  
     
  /// proc_c_General_journal_Entries Update stored procedure.
     
        public class proccGeneraljournalEntriesUpdateCommand : IRequest<IList<proccGeneraljournalEntries_org_ID>>
    {
