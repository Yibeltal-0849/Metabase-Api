...
{ 
	...
	#region Proc_J_Payment_Journal_Insert   
     
  /// Proc_J_Payment_Journal_Insert  stored procedure.
     
        public class ProcJPaymentJournalInsertCommand : IRequest<IList<procJPaymentJournal_Brnach_ID>>
    {
