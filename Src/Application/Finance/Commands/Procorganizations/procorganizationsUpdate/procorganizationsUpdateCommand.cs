...
{ 
	...
	#region proc_organizationsUpdate  
     
  /// proc_organizationsUpdate stored procedure.
     
        public class procorganizationsUpdateCommand : IRequest<IList<procorganizations_organization_Code>>
    {
