...
{ 
	...
	#region J_Fixed_Asset_JournalInsert  
     
  /// J_Fixed_Asset_JournalInsert stored procedure.
     
        public class JFixedAssetJournalInsertCommand : IRequest<IList<JFixedAssetJournal_Branch_ID>>
    {
