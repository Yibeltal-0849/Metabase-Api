...
{ 
	...
	#region J_Purchase_JournalUpdate  
     
  /// J_Purchase_JournalUpdate stored procedure.
     
        public class JPurchaseJournalUpdateCommand : IRequest<IList<JPurchaseJournal_Org_ID>>
    {
