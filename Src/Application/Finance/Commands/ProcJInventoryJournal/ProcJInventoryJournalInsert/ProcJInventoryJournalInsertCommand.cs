...
{ 
	...
	#region Proc_J_Inventory_Journal_Insert   
     
  /// Proc_J_Inventory_Journal_Insert  stored procedure.
     
        public class ProcJInventoryJournalInsertCommand : IRequest<IList<procInventoryPostingSetup_store_Code>>
    {
