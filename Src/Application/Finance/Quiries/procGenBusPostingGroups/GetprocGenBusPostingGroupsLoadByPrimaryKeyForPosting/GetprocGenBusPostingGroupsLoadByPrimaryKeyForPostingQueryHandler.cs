...
{
    public class GetprocGenBusPostingGroupsQueryHandler : IRequestHandler<GetprocGenBusPostingGroupsLoadByPrimaryKeyForPosting, GetprocGenBusPostingGroupsLoadAllListVm>
    {
        ...
        public async Task<GetprocGenBusPostingGroupsLoadAllListVm> Handle(GetprocGenBusPostingGroupsLoadByPrimaryKeyForPosting request, CancellationToken cancellationToken)
        {
           
            IList<GenBusPostingGroups> procGenBusPostingGroupss = await _procedureAdabter
               .Execute<GenBusPostingGroups>("[FINA].[proc_Gen_Bus_Posting_GroupsLoadByPrimaryKeyForPosting]", request);
