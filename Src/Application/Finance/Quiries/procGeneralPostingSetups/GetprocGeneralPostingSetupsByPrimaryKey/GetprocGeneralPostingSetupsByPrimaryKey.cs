...
{
    ///     /// @author  Shimels Alem [proc_General Posting SetupsLoadByPrimaryKey] stored procedure.

    public class GetprocGeneralPostingSetupsByPrimaryKey : IRequest<GetprocGeneralPostingSetupsLoadAllListVm>
    {
