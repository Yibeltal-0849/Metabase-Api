...
{
    public class GetprocSalesLinesQueryHandler : IRequestHandler<GetprocSalesLinesLoadByPrimaryKeyTransNo, GetprocSalesLinesLoadAllListVm>
    {
        ...
        public async Task<GetprocSalesLinesLoadAllListVm> Handle(GetprocSalesLinesLoadByPrimaryKeyTransNo request, CancellationToken cancellationToken)
        {
           
            IList<Sales_Lines> procSalesLiness = await _procedureAdabter
               .Execute<Sales_Lines>("[FINA].[proc_Sales_LinesLoadByPrimaryKey_Trans_No]", request);
