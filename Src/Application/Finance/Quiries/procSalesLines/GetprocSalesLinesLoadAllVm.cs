...
namespace Application.Finance.Quiries.procSalesLines
{
    public class GetprocSalesLinesLoadAllVm : IMapFrom<Sales_Lines>
    {
        ...
        {
            profile.CreateMap<Sales_Lines, GetprocSalesLinesLoadAllVm>();
        }
    }
}
