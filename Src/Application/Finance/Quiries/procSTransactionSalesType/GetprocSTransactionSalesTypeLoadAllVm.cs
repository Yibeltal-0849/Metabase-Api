...
namespace Application.Finance.Quiries.procSTransactionSalesType
{
    public class GetprocSTransactionSalesTypeLoadAllVm : IMapFrom<STransactionSalesType>
    {
        ...
        {
            profile.CreateMap<STransactionSalesType, GetprocSTransactionSalesTypeLoadAllVm>();
        }
    }
}
