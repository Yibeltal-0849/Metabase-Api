...
namespace Application.Finance.Quiries.procorganizations
{
    public class GetprocorganizationsLoadAllVm : IMapFrom<_procorganizations>
    {
        ...
        {
            profile.CreateMap<_procorganizations, GetprocorganizationsLoadAllVm>();
        }
    }
}
