...
{
    public class GetprocCBankDepositQueryHandler : IRequestHandler<GetprocCBankDepositByPrimaryKey, GetprocBankReconciliationLoadAllListVm>
    {
        ...
        public async Task<GetprocBankReconciliationLoadAllListVm> Handle(GetprocCBankDepositByPrimaryKey request, CancellationToken cancellationToken)
        {
           
            IList<CBankDeposit> procCBankDeposits = await _procedureAdabter
               .Execute<CBankDeposit>("[FINA].[proc_C_Bank_DepositLoadByPrimaryKey]", request);
