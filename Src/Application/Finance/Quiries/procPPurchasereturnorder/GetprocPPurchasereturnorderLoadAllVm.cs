...
namespace Application.Finance.Quiries.procPPurchasereturnorder
{
    public class GetprocPPurchasereturnorderLoadAllVm : IMapFrom<PPurchaseReturnOrder>
    {
        ...
        {
            profile.CreateMap<PPurchaseReturnOrder, GetprocPPurchasereturnorderLoadAllVm>();
        }
    }
}
