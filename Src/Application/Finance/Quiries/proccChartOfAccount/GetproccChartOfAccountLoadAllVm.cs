...
namespace Application.Finance.Quiries.proccChartOfAccount
{
    public class GetproccChartOfAccountLoadAllVm : IMapFrom<CChartOfAccount>
    {
        ...
        {
            profile.CreateMap<CChartOfAccount, GetproccChartOfAccountLoadAllVm>();
        }
    }
}
