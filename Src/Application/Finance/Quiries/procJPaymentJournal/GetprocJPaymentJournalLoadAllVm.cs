...
namespace Application.Finance.Quiries.procJPaymentJournal
{
    public class GetprocJPaymentJournalLoadAllVm : IMapFrom<JPaymentJournal>
    {
        ...
        {
            profile.CreateMap<JPaymentJournal, GetprocJPaymentJournalLoadAllVm>();
        }
    }
}
