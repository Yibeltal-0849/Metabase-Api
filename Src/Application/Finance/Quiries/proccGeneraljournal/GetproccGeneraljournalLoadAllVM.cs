...
namespace Application.Finance.Quiries.proccGeneraljournal
{ 
	 
	#region proccGeneraljournalLoadAll  
    
      public class GetproccGeneraljournalLoadAllVM : IMapFrom<GetproccGeneraljournalLoadAllListVM>
    {
        ...
        {
            profile.CreateMap< JGeneralJournal, GetproccGeneraljournalLoadAllVM>();
        }
    }
    #endregion
