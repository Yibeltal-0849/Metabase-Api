...
namespace Application.Finance.Quiries.procInventoryPostingSetup
{ 
	 
	#region procInventoryPostingSetupLoadAll  
    
      public class GetprocInventoryPostingSetupLoadAllVM : IMapFrom<GetprocInventoryPostingSetupLoadAllListVM>
    {
        ...
        {
            profile.CreateMap< InventoryPostingSetup, GetprocInventoryPostingSetupLoadAllVM>();
        }
    }
    #endregion
