...
namespace Application.Finance.Quiries.procCTransactionPurchase
{
    public class GetprocCTransactionPurchaseLoadAllVm : IMapFrom<CTransactionPurchase>
    {
        ...
        {
            profile.CreateMap<CTransactionPurchase, GetprocCTransactionPurchaseLoadAllVm>();
        }
    }
}
