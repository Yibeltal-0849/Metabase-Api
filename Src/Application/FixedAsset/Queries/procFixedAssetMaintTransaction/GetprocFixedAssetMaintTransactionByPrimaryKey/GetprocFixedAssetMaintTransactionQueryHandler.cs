...
{
    public class GetprocFixedAssetMaintTransactionQueryHandler : IRequestHandler<GetprocFixedAssetMaintTransactionByPrimaryKey, GetprocFixedAssetMaintTransactionLoadAllListVm>
    {
        ...
        public async Task<GetprocFixedAssetMaintTransactionLoadAllListVm> Handle(GetprocFixedAssetMaintTransactionByPrimaryKey request, CancellationToken cancellationToken)
        {
           
            IList<FixedAssetMaintTransaction> procFixedAssetMaintTransactions = await _procedureAdabter
               .Execute<FixedAssetMaintTransaction>("[FixedAsset].[proc_Fixed_Asset_Maint_TransactionLoadByPrimaryKey]", request);
