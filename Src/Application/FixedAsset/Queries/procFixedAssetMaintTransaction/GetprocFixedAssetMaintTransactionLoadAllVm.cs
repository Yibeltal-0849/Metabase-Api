...
namespace Application.FixedAsset.Quiries.procFixedAssetMaintTransaction
{
    public class GetprocFixedAssetMaintTransactionLoadAllVm : IMapFrom<FixedAssetMaintTransaction>
    {
        ...
        {
            profile.CreateMap<FixedAssetMaintTransaction, GetprocFixedAssetMaintTransactionLoadAllVm>();
        }
    }
}
