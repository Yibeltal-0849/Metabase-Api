...
namespace Application.FixedAsset.Quiries.procFixedAsset
{
    public class GetprocFixedAssetLoadAllVm : IMapFrom<Fixed_Asset>
    {
        ...
        {
            profile.CreateMap<Fixed_Asset, GetprocFixedAssetLoadAllVm>();
        }
    }
}
