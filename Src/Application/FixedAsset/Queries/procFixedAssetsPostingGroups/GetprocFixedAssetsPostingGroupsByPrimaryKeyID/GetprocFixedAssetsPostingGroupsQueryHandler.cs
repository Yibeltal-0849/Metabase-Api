...
{
    public class GetprocFixedAssetsPostingGroupsQueryHandler : IRequestHandler<GetprocFixedAssetsPostingGroupsByPrimaryKeyID, GetprocFixedAssetsPostingGroupsLoadAllListVm>
    {
        ...
        public async Task<GetprocFixedAssetsPostingGroupsLoadAllListVm> Handle(GetprocFixedAssetsPostingGroupsByPrimaryKeyID request, CancellationToken cancellationToken)
        {
           
            IList<FixedAssetsPostingGroups> procFixedAssetsPostingGroupss = await _procedureAdabter
               .Execute<FixedAssetsPostingGroups>("[FixedAsset].[proc_Fixed_Assets_Posting_GroupsLoadByPrimaryKeyID]", request);
