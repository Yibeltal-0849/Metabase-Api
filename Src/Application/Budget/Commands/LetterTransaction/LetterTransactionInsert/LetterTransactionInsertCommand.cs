...
namespace Application.Budget.Commands.LetterTransaction.LetterTransactionInsert.LetterTransactionInsertCommand
{
	...
	///  public @author Shimels Alem  Letter_TransactionInsert stored procedure.

	public class LetterTransactionInsertCommand : IRequest<IList<LetterTransaction_Letter_ID>>
    {
