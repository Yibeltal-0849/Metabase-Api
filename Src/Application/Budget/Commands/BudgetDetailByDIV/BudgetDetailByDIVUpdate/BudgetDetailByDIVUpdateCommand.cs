...
namespace Application.Budget.Commands.BudgetDetailByDIV.BudgetDetailByDIVUpdate.BudgetDetailByDIVUpdateCommand
{
    ...
    ///   @author Shimels Alem Budget_DetailByDIVUpdate stored procedure.

    public class BudgetDetailByDIVUpdateCommand : IRequest<IList<Budget_DetailByDiv_Budget_DetailID>>
    {
