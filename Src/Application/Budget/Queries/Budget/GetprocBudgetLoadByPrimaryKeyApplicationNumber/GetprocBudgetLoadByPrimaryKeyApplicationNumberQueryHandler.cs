...
{
    public class GetBudgetQueryHandler : IRequestHandler<GetprocBudgetLoadByPrimaryKeyApplicationNumber, GetBudgetLoadAllListVm>
    {
        ...
        public async Task<GetBudgetLoadAllListVm> Handle(GetprocBudgetLoadByPrimaryKeyApplicationNumber request, CancellationToken cancellationToken)
        {
           
            IList<_Budget> Budgets = await _procedureAdabter
               .Execute<_Budget>("[Budget].[proc_BudgetLoadByPrimaryKey_Application_Number]", request);
