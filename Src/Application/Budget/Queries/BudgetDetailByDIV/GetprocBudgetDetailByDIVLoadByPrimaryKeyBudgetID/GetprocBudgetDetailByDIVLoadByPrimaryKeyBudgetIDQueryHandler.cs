...
{
    public class GetBudgetDetailByDIVQueryHandler : IRequestHandler<GetprocBudgetDetailByDIVLoadByPrimaryKeyBudgetID, GetBudgetDetailByDIVLoadAllListVm>
    {
        ...
        public async Task<GetBudgetDetailByDIVLoadAllListVm> Handle(GetprocBudgetDetailByDIVLoadByPrimaryKeyBudgetID request, CancellationToken cancellationToken)
        {
           
            IList<Budget_DetailByDiv> BudgetDetailByDIVs = await _procedureAdabter
               .Execute<Budget_DetailByDiv>("[Budget].[proc_Budget_DetailByDIVLoadByPrimaryKey_Budget_ID]", request);
