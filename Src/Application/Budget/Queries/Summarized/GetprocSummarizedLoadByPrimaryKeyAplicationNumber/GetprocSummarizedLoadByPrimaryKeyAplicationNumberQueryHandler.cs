...
{
    public class GetSummarizedQueryHandler : IRequestHandler<GetprocSummarizedLoadByPrimaryKeyAplicationNumber, GetSummarizedLoadAllListVm>
    {
        ...
        public async Task<GetSummarizedLoadAllListVm> Handle(GetprocSummarizedLoadByPrimaryKeyAplicationNumber request, CancellationToken cancellationToken)
        {
           
            IList<_Summarized> Summarizeds = await _procedureAdabter
               .Execute<_Summarized>("[Budget].[proc_SummarizedLoadByPrimaryKey_Aplication_Number]", request);
