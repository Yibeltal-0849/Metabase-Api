...
namespace XOKA.Application.BSC.Commands.InnitiativePlanAssignment.CreateInnitiativePlanAssignment
{
    public class CreateInnitiativePlanAssignmentHandler : IRequestHandler<CreateInnitiativePlanAssignmentCommand, IList<Innitiative_Plan_Assignment_IPA_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public CreateInnitiativePlanAssignmentHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Innitiative_Plan_Assignment_IPA_ID>> Handle(CreateInnitiativePlanAssignmentCommand request, CancellationToken cancellationToken)
        {
         ...
         IList<Innitiative_Plan_Assignment_IPA_ID> result = await _procedureAdabter
                .Execute<Innitiative_Plan_Assignment_IPA_ID>("[BSC].[Innitiative_Plan_AssignmentInsert]",
