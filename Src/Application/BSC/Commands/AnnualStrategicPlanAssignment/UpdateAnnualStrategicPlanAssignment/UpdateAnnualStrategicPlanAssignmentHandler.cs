...
{
    public class UpdateAnnualStrategicPlanAssignmentHandler : IRequestHandler<UpdateAnnualStrategicPlanAssignmentCommand, IList<Proc_Annual_Strategic_Plan_Assignment_ASPA_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public UpdateAnnualStrategicPlanAssignmentHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Proc_Annual_Strategic_Plan_Assignment_ASPA_ID>> Handle(UpdateAnnualStrategicPlanAssignmentCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<Proc_Annual_Strategic_Plan_Assignment_ASPA_ID> result = await _procedureAdabter
                .Execute<Proc_Annual_Strategic_Plan_Assignment_ASPA_ID>("[BSC].[proc_Annual_Strategic_Plan_AssignmentUpdate]", (nameof(ASPA_ID), ASPA_ID), (nameof(ASGD_ID), ASGD_ID),
