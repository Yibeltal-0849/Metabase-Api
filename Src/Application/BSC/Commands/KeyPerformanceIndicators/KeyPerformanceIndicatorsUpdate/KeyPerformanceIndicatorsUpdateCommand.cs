...
namespace Application.BSC.Commands.KeyPerformanceIndicators.KeyPerformanceIndicatorsUpdate.KeyPerformanceIndicatorsUpdateCommand
{
	...
	///   @author  Shimels Alem Key_Performance_IndicatorsUpdate stored procedure.

	public class KeyPerformanceIndicatorsUpdateCommand : IRequest<IList<Key_Performance_Indicators_KPI_ID>>
	{
