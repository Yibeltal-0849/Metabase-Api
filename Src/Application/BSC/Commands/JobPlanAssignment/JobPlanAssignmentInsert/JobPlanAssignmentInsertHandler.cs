...
namespace Application.BSC.Commands.JobPlanAssignment.JobPlanAssignmentInsert.JobPlanAssignmentInsertCommand
{
    ...
    public class JobPlanAssignmentInsertHandler : IRequestHandler<JobPlanAssignmentInsertCommand, IList<JobPlanAssignment_JobPA_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public JobPlanAssignmentInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<JobPlanAssignment_JobPA_ID>> Handle( JobPlanAssignmentInsertCommand request, CancellationToken cancellationToken)
        {
         ...
         IList<JobPlanAssignment_JobPA_ID> result = await _procedureAdabter
                .Execute<JobPlanAssignment_JobPA_ID>("[BSC].Job_Plan_AssignmentInsert",
