...
{
    public class UpdateCompanyStrategyHandler : IRequestHandler<UpdateCompanyStrategyCommand, IList<Proc_Company_Strategy_Strategy_NO>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public UpdateCompanyStrategyHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Proc_Company_Strategy_Strategy_NO>> Handle(UpdateCompanyStrategyCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<Proc_Company_Strategy_Strategy_NO> result = await _procedureAdabter
                .Execute<Proc_Company_Strategy_Strategy_NO>("[BSC].[proc_Company_StrategyUpdate]",
                (nameof(Strategy_NO), Strategy_NO), (nameof(Organization_code), Organization_code), (nameof(Title), Title),
