...
namespace XOKA.Application.BSC.Commands.Chart_Of_Account.CreateCChartOfAccount
{
    public class CreateCChartOfAccountHandler : IRequestHandler<CreateCChartOfAccountCommand, IList<Proc_C_Chart_Of_Account_Account_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public CreateCChartOfAccountHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Proc_C_Chart_Of_Account_Account_ID>> Handle(CreateCChartOfAccountCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<Proc_C_Chart_Of_Account_Account_ID> result = await _procedureAdabter
                .Execute<Proc_C_Chart_Of_Account_Account_ID>("[BSC].[proc_c_Chart_Of_AccountInsert]", (nameof(Account_ID), Account_ID), (nameof(Org_ID), Org_ID),
