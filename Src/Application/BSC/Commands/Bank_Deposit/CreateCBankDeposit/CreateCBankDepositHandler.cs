...
{
    public class CreateCBankDepositHandler : IRequestHandler<CreateCBankDepositCommand, IList<Proc_C_Bank_Deposit_Id>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public CreateCBankDepositHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Proc_C_Bank_Deposit_Id>> Handle(CreateCBankDepositCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<Proc_C_Bank_Deposit_Id> result = await _procedureAdabter
                .Execute<Proc_C_Bank_Deposit_Id>("[BSC].[proc_C_Bank_DepositInsert]", (nameof(BankName), BankName), (nameof(DepositTicketDate), DepositTicketDate),
