...
namespace Application.BSC.Commands.StrategicInnitiative.StrategicInnitiativeInsert.StrategicInnitiativeInsertCommand
{
	...
	///   @author  Shimels Alem Strategic_InnitiativeInsert stored procedure.

	public class StrategicInnitiativeInsertCommand : IRequest<IList<Strategic_Innitiative_Innitiative_ID>>
    {
