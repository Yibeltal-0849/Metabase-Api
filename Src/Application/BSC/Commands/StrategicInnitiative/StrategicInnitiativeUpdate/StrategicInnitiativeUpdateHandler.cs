...
{ 
      ...
      public class StrategicInnitiativeUpdateHandler : IRequestHandler<StrategicInnitiativeUpdateCommand, IList<Strategic_Innitiative_Innitiative_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public StrategicInnitiativeUpdateHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Strategic_Innitiative_Innitiative_ID>> Handle( StrategicInnitiativeUpdateCommand request, CancellationToken cancellationToken)
        {
			...
			IList<Strategic_Innitiative_Innitiative_ID> result = await _procedureAdabter
                .Execute<Strategic_Innitiative_Innitiative_ID>("[BSC].Strategic_InnitiativeUpdate",
