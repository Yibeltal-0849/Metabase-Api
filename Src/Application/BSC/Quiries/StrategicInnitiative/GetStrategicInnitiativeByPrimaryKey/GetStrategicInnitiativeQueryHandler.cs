...
{
    public class GetStrategicInnitiativeQueryHandler : IRequestHandler<GetStrategicInnitiativeByPrimaryKey, GetStrategicInnitiativeLoadAllListVm>
    {
        ...
        public async Task<GetStrategicInnitiativeLoadAllListVm> Handle(GetStrategicInnitiativeByPrimaryKey request, CancellationToken cancellationToken)
        {
            
            IList<Strategic_Innitiative> StrategicInnitiatives = await _procedureAdabter
               .Execute<Strategic_Innitiative>("[BSC].[proc_Strategic_InnitiativeLoadByPrimaryKey]", request);
