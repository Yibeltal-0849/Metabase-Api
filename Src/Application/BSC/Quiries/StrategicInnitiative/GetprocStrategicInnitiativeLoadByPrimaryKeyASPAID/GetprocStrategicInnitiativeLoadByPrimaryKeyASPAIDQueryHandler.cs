...
{
    public class GetStrategicInnitiativeQueryHandler : IRequestHandler<GetprocStrategicInnitiativeLoadByPrimaryKeyASPAID, GetStrategicInnitiativeLoadAllListVm>
    {
        ...
        public async Task<GetStrategicInnitiativeLoadAllListVm> Handle(GetprocStrategicInnitiativeLoadByPrimaryKeyASPAID request, CancellationToken cancellationToken)
        {
            
            IList<Strategic_Innitiative> StrategicInnitiatives = await _procedureAdabter
               .Execute<Strategic_Innitiative>("[BSC].[proc_Strategic_InnitiativeLoadByPrimaryKey_ASPA_ID]", request);
