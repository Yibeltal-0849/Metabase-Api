...
{
    public class GetAnnualStrategicPlanAssignmentQueryHandler : IRequestHandler<GetAnnualStrategicPlanAssignmentByPrimaryKey, GetAnnualStrategicPlanAssignmentLoadAllListVm>
    {
        ...
        public async Task<GetAnnualStrategicPlanAssignmentLoadAllListVm> Handle(GetAnnualStrategicPlanAssignmentByPrimaryKey request, CancellationToken cancellationToken)
        {
            Guid ASPA_ID = request.ASPA_ID;
            IList<Proc_Annual_Strategic_Plan_Assignment> annualStrategicPlans = await _procedureAdabter
               .Execute<Proc_Annual_Strategic_Plan_Assignment>("[BSC].[proc_Annual_Strategic_Plan_AssignmentLoadByPrimaryKey]", (nameof(ASPA_ID), ASPA_ID));
