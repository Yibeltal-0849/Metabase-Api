...
namespace Application.BSC.Quiries.procJobPlanAssignment
{
    public class GetprocJobPlanAssignmentLoadAllVm : IMapFrom<JobPlanAssignment>
    {
        ...
        {
            profile.CreateMap<JobPlanAssignment, GetprocJobPlanAssignmentLoadAllVm>();
        }
    }
}
