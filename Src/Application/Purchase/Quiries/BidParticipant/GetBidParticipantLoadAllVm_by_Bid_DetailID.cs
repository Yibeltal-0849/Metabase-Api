...
{
    public class GetBidParticipantLoadAllVm_by_Bid_DetailID : IMapFrom<Bid_Participant>
	{
		...
		{
			profile.CreateMap<Bid_Participant, GetBidParticipantLoadAllVm_by_Bid_DetailID>();
		}
	}
}
