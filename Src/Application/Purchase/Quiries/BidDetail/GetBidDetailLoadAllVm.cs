...
namespace Application.Purchase.Quiries.BidDetail
{
    public class GetBidDetailLoadAllVm : IMapFrom<Bid_Detail>
    {
        ...
        {
            profile.CreateMap<Bid_Detail, GetBidDetailLoadAllVm>();
        }
    }
}
