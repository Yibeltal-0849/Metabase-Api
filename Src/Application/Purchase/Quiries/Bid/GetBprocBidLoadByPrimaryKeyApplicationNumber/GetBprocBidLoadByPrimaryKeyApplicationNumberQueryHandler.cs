...
{
    public class GetBidQueryHandler : IRequestHandler<GetBprocBidLoadByPrimaryKeyApplicationNumber, GetBidLoadAllListVm>
    {
        ...
        public async Task<GetBidLoadAllListVm> Handle(GetBprocBidLoadByPrimaryKeyApplicationNumber request, CancellationToken cancellationToken)
        {
           
            IList<_Bid> Bids = await _procedureAdabter
               .Execute<_Bid>("[Purchase].[proc_BidLoadByPrimaryKey_Application_Number]", request);
