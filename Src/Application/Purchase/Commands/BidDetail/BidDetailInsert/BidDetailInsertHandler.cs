...
namespace Application.Purchase.Commands.BidDetail.BidDetailInsert.BidDetailInsertCommand
{

    /// @author  Shimels Alem  proc_Bid_DetailInsert stored procedure.


    public class BidDetailInsertHandler : IRequestHandler<BidDetailInsertCommand, IList<Bid_Detail_Bid_DetailID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public BidDetailInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Bid_Detail_Bid_DetailID>> Handle( BidDetailInsertCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<Bid_Detail_Bid_DetailID> result = await _procedureAdabter
                    .Execute<Bid_Detail_Bid_DetailID>("[Purchase].proc_Bid_DetailInsert",
