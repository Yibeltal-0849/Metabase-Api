...
namespace Application.Purchase.Commands.BidSubmission.BidSubmissionUpdate.BidSubmissionUpdateCommand
{
    ...
    public class BidSubmissionUpdateHandler : IRequestHandler<BidSubmissionUpdateCommand, IList<BidSubmission_ParticipantID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public BidSubmissionUpdateHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<BidSubmission_ParticipantID>> Handle( BidSubmissionUpdateCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<BidSubmission_ParticipantID> result = await _procedureAdabter
                .Execute<BidSubmission_ParticipantID>("[Purchase].proc_Bid_SubmtionUpdate",
