...
namespace Application.ProprtyData.Queries.proctblInstitution
{
    public class GetproctblInstitutionLoadAllVm : IMapFrom<tblInstitution>
    {
        ...
        {
            profile.CreateMap<tblInstitution, GetproctblInstitutionLoadAllVm>();
        }
    }
}
