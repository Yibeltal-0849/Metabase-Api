...
{
    public class GetprocProportyDataCollectionTransactionQueryHandler : IRequestHandler<GetprocProportyDataCollectionTransactionByPrimaryKey, GetprocProportyDataCollectionTransactionListVm>
    {
        ...
        public async Task<GetprocProportyDataCollectionTransactionListVm> Handle(GetprocProportyDataCollectionTransactionByPrimaryKey request, CancellationToken cancellationToken)
        {
           
            IList<Proporty_Data_Collection_Transaction> procProportyDataCollection = await _procedureAdabter
               .Execute<Proporty_Data_Collection_Transaction>("[ProprtyData].[proc_Proporty_Data_Collection_TransactionLoadByPrimaryKey]", request);
