...
namespace Application.ProprtyData.Queries.proctblResource
{
    public class GetproctblResourceLoadAllVm : IMapFrom<tblResource>
    {
        ...
        {
            profile.CreateMap<tblResource, GetproctblResourceLoadAllVm>();
        }
    }
}
