...
namespace Application.Inventory.Commands.InventoryItems.InventoryItemsInsert.InventoryItemsInsertCommand
{

    /// @author  Shimels Alem  Inventory_ItemsInsert stored procedure.


    public class InventoryItemsInsertHandler : IRequestHandler<InventoryItemsInsertCommand, IList<Inventory_Items_Inv_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public InventoryItemsInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Inventory_Items_Inv_ID>> Handle( InventoryItemsInsertCommand request, CancellationToken cancellationToken)
        {
        ...
        IList<Inventory_Items_Inv_ID> result = await _procedureAdabter
                .Execute<Inventory_Items_Inv_ID>("[Inventory].Inventory_ItemsInsert",
