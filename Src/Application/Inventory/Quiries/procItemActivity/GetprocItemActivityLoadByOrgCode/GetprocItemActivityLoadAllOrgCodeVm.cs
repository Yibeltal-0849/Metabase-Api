...
{
    public class GetprocItemActivityLoadAllOrgCodeVm: IMapFrom<ItemActivityOrgCode>
    {
        ...
        {
            profile.CreateMap<ItemActivityOrgCode, GetprocItemActivityLoadAllOrgCodeVm>();
        }
    }
}
