...
{
    public class GetprocItemActivityQueryHandler : IRequestHandler<GetprocItemActivityLoadByPrimaryKeyApplicationNumber, GetprocItemActivityLoadAllListVm>
    {
        ...
        public async Task<GetprocItemActivityLoadAllListVm> Handle(GetprocItemActivityLoadByPrimaryKeyApplicationNumber request, CancellationToken cancellationToken)
        {
           
            IList<ItemActivity> procItemActivitys = await _procedureAdabter
               .Execute<ItemActivity>("[Inventory].[proc_Item_ActivityLoadByPrimaryKey_Application_Number]", request);
