...
{
    public class GetInventoryItemsQueryHandler : IRequestHandler<GetprocInventoryItemsLoadByPrimaryKeyOrgID, GetInventoryItemsLoadAllListVm>
    {
        ...
        public async Task<GetInventoryItemsLoadAllListVm> Handle(GetprocInventoryItemsLoadByPrimaryKeyOrgID request, CancellationToken cancellationToken)
        {
           
            IList<Inventory_Items> InventoryItemss = await _procedureAdabter
               .Execute<Inventory_Items>("[Inventory].[proc_Inventory_ItemsLoadByPrimaryKey_OrgID]", request);
