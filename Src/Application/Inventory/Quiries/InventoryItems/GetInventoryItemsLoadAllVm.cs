...
{
    public class GetInventoryItemsLoadAllVm : IMapFrom<Inventory_Items>
    {
        ...
        public float Proft { get; set; }
        public void Mapping(Profile profile)
        {
            profile.CreateMap<Inventory_Items, GetInventoryItemsLoadAllVm>();
        }
    }
}
