...
namespace Application.Finance.Quiries.GetAvalable_credit
{
    public class Avalable_credit : IMapFrom<AvalableDiscount>
    {
        ...
        {
            profile.CreateMap<AvalableDiscount, Avalable_credit>();
        }
    }
}
