...
namespace Application.Inventory.Quiries.procItemType
{
    public class GetprocItemTypeLoadAllVm : IMapFrom<ItemType>
    {
        ...
        {
            profile.CreateMap<ItemType, GetprocItemTypeLoadAllVm>();
        }
    }
}
