...
{
    /// @author  Shimels Alem  CreateCOrganizational_Structure stored procedure.
    
    public class CreateOrganizational_StructureCommand : IRequest<IList<OrganizationalStructure_Structure_ID>>
    {
