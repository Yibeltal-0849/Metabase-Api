...
{
    /// @author  Shimels Alem  CreateCTraining_Application stored procedure.
    
    public class CreateTraining_ApplicationCommand : IRequest<IList<TrainingApplication_Training_Planed_ID>>
    {
