...
{
    /// @author  Shimels Alem  proc_Payrole_TransactionUpdate stored procedure.

    public class UpdatePayrole_TransactionCommand : IRequest<IList<PayroleTransaction_Payrole_Trans_Id>>
    {
