...
{
    public class CreateCAccountCatHandler : IRequestHandler<CreateCEmployeVacationAndSickTimeCommand, IList<Proc_C_Employe_VacationAndSickTime_id>>
    {
        ...
        public async Task<IList<Proc_C_Employe_VacationAndSickTime_id>> Handle(CreateCEmployeVacationAndSickTimeCommand request, CancellationToken cancellationToken)
        {
            long? id = request.id;
            ...
            IList<Proc_C_Employe_VacationAndSickTime_id> result = await _procedureAdabter
                    .Execute<Proc_C_Employe_VacationAndSickTime_id>("[HRA].[proc_c_Employe_VacationAndSickTimeInsert]", (nameof(id), id), (nameof(Employee_Id), Employee_Id), (nameof(UseDefault), UseDefault),
