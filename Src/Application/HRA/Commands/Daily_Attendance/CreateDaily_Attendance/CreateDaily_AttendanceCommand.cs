...
{
    /// @author  Shimels Alem  CreateCDaily_Attendance stored procedure.
    
    public class CreateDaily_AttendanceCommand : IRequest<IList<DailyAttendance_Deily_Attemdance_ID>>
    {
