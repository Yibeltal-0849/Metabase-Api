...
namespace XOKA.Application.HRA.Commands.Pay_Slip.UpdatePay_Slip
{
    public class UpdatePay_SlipHandler : IRequestHandler<UpdatePay_SlipCommand, IList<PaySlip_Pay_Slip_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public UpdatePay_SlipHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<PaySlip_Pay_Slip_ID>> Handle(UpdatePay_SlipCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<PaySlip_Pay_Slip_ID> result = await _procedureAdabter
                .Execute<PaySlip_Pay_Slip_ID>("[HRA].[Pay_SlipUpdate]",
