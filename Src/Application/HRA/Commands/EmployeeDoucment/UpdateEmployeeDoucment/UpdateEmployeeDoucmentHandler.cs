...
{
    public class UpdateEmployeeDoucmentHandler : IRequestHandler<UpdateEmployeeDoucmentCommand, IList<EmployeeDoucment_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public UpdateEmployeeDoucmentHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<EmployeeDoucment_ID>> Handle(UpdateEmployeeDoucmentCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<EmployeeDoucment_ID> result = await _procedureAdabter
                .Execute<EmployeeDoucment_ID>("[HRA].[proc_Emplyee_DocumentsUpdate]",
