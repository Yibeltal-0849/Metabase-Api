...
{
    /// @author  Shimels Alem  proc_Planed_TrainingInsert stored procedure.
    
    public class CreatePlaned_TrainingCommand : IRequest<IList<PlanedTraining_Training_Planed_ID>>
    {
