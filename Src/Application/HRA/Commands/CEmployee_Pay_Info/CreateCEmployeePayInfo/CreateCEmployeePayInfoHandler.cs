...
{
    public class CreateCEmployeePayInfoHandler : IRequestHandler<CreateCEmployeePayInfoCommand, IList<CEmployeePayInfo_id>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public CreateCEmployeePayInfoHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<CEmployeePayInfo_id>> Handle(CreateCEmployeePayInfoCommand request, CancellationToken cancellationToken)
        {
            long id = request.id;
            ...
            IList<CEmployeePayInfo_id> result = await _procedureAdabter
                .Execute<CEmployeePayInfo_id>("[HRA].[proc_c_EmployeePayInfoInsert]",
                (nameof(id), id),
