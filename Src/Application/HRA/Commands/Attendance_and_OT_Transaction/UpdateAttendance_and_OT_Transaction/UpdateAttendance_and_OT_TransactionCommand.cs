...
{
    /// @author  Shimels Alem  UpdateCAttendance_and_OT_Transaction stored procedure.
    
    public class UpdateAttendance_and_OT_TransactionCommand : IRequest<IList<AttendanceAndOtTransaction_Att_OT_Trans_Id>>
    {
