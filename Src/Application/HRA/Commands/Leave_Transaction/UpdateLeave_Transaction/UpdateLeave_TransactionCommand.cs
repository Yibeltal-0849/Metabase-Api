...
{
    /// @author  Shimels Alem  proc_Leave_TransactionUpdate stored procedure.

    public class UpdateLeave_TransactionCommand : IRequest<IList<LeaveApproval_Leave_Tran_ID>>
    {
