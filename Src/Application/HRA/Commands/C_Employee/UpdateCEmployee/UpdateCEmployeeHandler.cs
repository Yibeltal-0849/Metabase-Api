...
namespace XOKA.Application.HRA.Commands.CEmployee.UpdateCEmployee
{
    public class UpdateCEmployeeHandler : IRequestHandler<UpdateCEmployeeCommand, IList<CEmployee_Employee_Id>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public UpdateCEmployeeHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<CEmployee_Employee_Id>> Handle(UpdateCEmployeeCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<CEmployee_Employee_Id> result = await _procedureAdabter
                .Execute<CEmployee_Employee_Id>("[HRA].[C_EmployeeUpdate]",
