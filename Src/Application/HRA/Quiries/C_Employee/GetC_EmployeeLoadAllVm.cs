...
namespace XOKA.Application.HRA.Quiries.C_Employee
{
    public class GetC_EmployeeLoadAllVm : IMapFrom<CEmployee>
    {
        ...
        {
            profile.CreateMap<CEmployee, GetC_EmployeeLoadAllVm>();
        }
    }
}
