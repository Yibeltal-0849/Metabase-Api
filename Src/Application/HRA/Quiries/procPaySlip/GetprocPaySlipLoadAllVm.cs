...
namespace Application.HRA.Quiries.procPaySlip
{
    public class GetprocPaySlipLoadAllVm : IMapFrom<PaySlip>
    {
		...
		public System.Double? Addistion_After_tax { get; set; }
		public System.Double? Deduction_After_Tax { get; set; }
        ...
        {
            profile.CreateMap<PaySlip, GetprocPaySlipLoadAllVm>();
        }
    }
}
