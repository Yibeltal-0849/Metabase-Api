...
namespace XOKA.Application.HRA.Quiries.Planed_Training
{
    public class GetPlaned_TrainingLoadAllVm : IMapFrom<PlanedTraining>
    {
        ...
        {
            profile.CreateMap<PlanedTraining, GetPlaned_TrainingLoadAllVm>();
        }
    }
}
