...
namespace WebUI.Services
{
    ...
    //    public SoapService(IHttpClientFactory httpClientFactory)
    //    {
    ...
    //        // Create a StringContent with the SOAP XML and set the content type
    //        var content = new StringContent(soapXml, Encoding.UTF8, "text/xml"); // You might need to adjust the content type
    //        string contentStringValue = await content.ReadAsStringAsync();
    //        // Send the HTTP POST request to the REST endpoint

    //        var response = await httpClient.PostAsync("https://localhost:44376/api/finance/procC2BPaymentQueryRequest/rest/1/1/1/1/B2_SCM_25_05_23_1/09117644416", content);

    //        // Read and return the SOAP response
    //        var soapResponse = await response.Content.ReadAsStringAsync();
    //        string path = "c:\\attendance\\log.txt";
    //        using (StreamWriter writer = new StreamWriter(path, true))
    //        {
    //            writer.WriteLine("soapXml::"+soapXml);
    //            writer.WriteLine("content::" + contentStringValue);
    //            writer.WriteLine("response::"+response);
    //            writer.WriteLine("soapResponse::" + soapResponse);
    //            writer.Close();
    //        }
    ...
    public class SoapSecuredService
    {
       ...
       // private readonly teleDbContext _dbContext; // Inject your DbContext here
        ...
        public SoapSecuredService( IConfiguration _configuration)
        {
