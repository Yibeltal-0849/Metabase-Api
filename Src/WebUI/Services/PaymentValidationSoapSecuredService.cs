...
namespace WebUI.Services
{
    ...
    public class PaymentValidationSoapSecuredService
    {
        ...
        public PaymentValidationSoapSecuredService( IConfiguration _configuration)
        {
        ...
        private string ConstructSoapResponse(C2BPaymentValidationRequestmap result)
        {
            ...
            var soapResponseXml = new XElement(soapenv + "Envelope",
                ...
                new XElement(soapenv + "Body",
                    new XElement(c2b + "C2BPaymentValidationResult", // Use the c2b namespace
        ...
        //private string ConstructSoapResponse(List<C2BPaymentValidationRequest> results)
        //{
        //    // Define the namespaces
        //    XNamespace soapenv = "http://schemas.xmlsoap.org/soap/envelope/";
        //    XNamespace c2b = "http://cps.huawei.com/cpsinterface/c2bpayment";
        ...
        //        new XElement(soapenv + "Header"),
        //        new XElement(soapenv + "Body",
        //            new XElement(c2b + "C2BPaymentValidationResult",
